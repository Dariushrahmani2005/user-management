      ...
      <div className="max-w-4xl mx-auto">
        <div className="bg-white/10 backdrop-blur-xl rounded-3xl p-8 border border-white/10">
          ...
          <div className="flex items-center gap-4 mb-8">
            ...
            <div>
              <h2 className="text-3xl font-bold text-white">ایجاد کاربر جدید</h2>
              <p className="text-gray-300 mt-2">اطلاعات کاربر جدید را وارد کنید</p>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            {/* Password Field */}
            <div>
              <label className="block text-gray-300 mb-2 text-sm font-medium">رمز عبور</label>
              <input
                type="password"
                name="password"
            ...
            <div className="flex gap-4 pt-6">
              <button
                ...
                className="flex-1 bg-gradient-to-r from-green-500 to-emerald-600 hover:from-green-600 hover:to-emerald-700 text-white font-bold py-4 px-8 rounded-2xl transition disabled:opacity-50"
              >
